...
const portfolioProjects = [
  ...
  },
  {
    ...
    image: 'https://i.postimg.cc/Nj54Wzk2/Screenshot-2025-08-05-174219.png',
  ...
  {
    id: 5,
    title: 'Medikit Healthcare',
    description:
      'Comprehensive React-based healthcare platform allowing users to upload prescriptions, order medicines, track deliveries, and consult with healthcare professionals through integrated telemedicine features.',
    image: 'https://i.postimg.cc/prP1hkYR/Screenshot-2025-08-05-151011.png',
    link: 'https://medikit-hc.netlify.app/',
    category: 'Health Tech',
    technologies: ['React', 'JSX', 'Tailwind CSS', 'Firebase'],
  },
  {
    id: 6,
    title: 'Job Portal Platform',
    description:
      'Feature-rich job listing portal with advanced HTML and JavaScript filtering options. Includes job search, application tracking, employer dashboard, and real-time notifications for job seekers and recruiters.',
    image: 'https://i.postimg.cc/SQCG499V/Screenshot-2025-08-05-173149.png',
    link: 'https://comforting-crostata-f1f7ec.netlify.app/',
    category: 'Web Development',
    technologies: ['HTML5', 'CSS3', 'JavaScript', 'Local Storage'],
  },
];

// Import PDFs (place these files in your public folder)
import DataSciencePDF from '../pdf/Data_Science_Projects.pdf';
import AiMlPDF from '../pdf/AI_ML_Projects.pdf';
import WebDevPDF from '../pdf/Web_Development_Projects.pdf';
...
const Projects = () => {
  ...
  const handlePdfDownload = async (pdfUrl, pdfName, categoryName) => {
  ...
  const handleEmailRequest = (pdfName, categoryName) => {
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 py-12">
        ...
        <div className="grid md:grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-8 mb-16">
          {filteredCategories.map((category, index) => (
            ...
            >
              <InteractiveCard glowColor={category.color} className="h-full">
                <div className="mb-6">
                  <h3
                ...
                <div className="space-y-3">
                  <button
                    ...
                    className={`w-full flex items-center justify-center gap-2 px-6 py-3 rounded-lg font-medium transition-all duration-300 shadow-lg btn-hover-effect disabled:opacity-50 disabled:cursor-not-allowed ${
                  ...
                  <button
                    ...
                    className={`w-full flex items-center justify-center gap-2 px-6 py-3 rounded-lg font-medium transition-all duration-300 border-2 ${
                      isDark
